      ...
      <section className="pt-20 pb-12 circuit-bg">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="mb-6 flex items-start relative">
            {/* Cyan accent line ONLY next to heading */}
          ...
          <p className="text-base text-muted-foreground animate-fade-in-delayed max-w-2xl pl-2 md:pl-8">
            Want a similar program for your school or institution? Don’t hesitate to reach out!
          </p>
        </div>
      </section>
