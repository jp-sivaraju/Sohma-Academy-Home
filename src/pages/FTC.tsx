...
const FTC = () => {
  ...
  const ftcImages = [ftc1, ftc2, ftc3, ftc4];
      ...
      <section className="pt-20 pb-12 circuit-bg">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <p className="text-base text-muted-foreground animate-fade-in-delayed pl-2 md:pl-8">
            ...
            We, Soham Academy (#24067), made our debut in the First Tech Challenge (FTC), joining a vibrant community of innovators from
            India, Kazakhstan, and Sri Lanka! This was our first-ever international Robotics Competition. Students from ZPHS, Boduppal and GHS
            Police Boys, CPL actively participated and impressed judges during interviews, showcasing our meticulously crafted robot. This
            participation in FTC marked a landmark event for us, igniting a new level of inspiration.
          </p>
        </div>
      </section>
